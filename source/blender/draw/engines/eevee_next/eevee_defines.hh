...
#define SHADOW_TILEDATA_PER_TILEMAP \
  (((SHADOW_TILEMAP_RES / 1) * (SHADOW_TILEMAP_RES / 1)) + \
   ((SHADOW_TILEMAP_RES / 2) * (SHADOW_TILEMAP_RES / 2)) + \
   ((SHADOW_TILEMAP_RES / 4) * (SHADOW_TILEMAP_RES / 4)) + \
   ((SHADOW_TILEMAP_RES / 8) * (SHADOW_TILEMAP_RES / 8)) + \
   ((SHADOW_TILEMAP_RES / 16) * (SHADOW_TILEMAP_RES / 16)))
