 ...
 */
static const uiTextIconPadFactor ui_text_pad_default = {
    .text = 1.50f,
    .icon = 0.25f,
    .icon_only = 0.0f,
};
...
static const uiTextIconPadFactor ui_text_pad_compact = {
    .text = 1.25f,
    .icon = 0.35f,
    .icon_only = 0.0f,
};
...
static const uiTextIconPadFactor ui_text_pad_none = {
    .text = 0.25f,
    .icon = 1.50f,
    .icon_only = 0.0f,
};
